(function () {
     ...
     * @returns {function(new:Memory_Models_Game_Clock)}   - todo: correct this if it returns a singleton instance as opposed to the constructor
     * @constructor
     */
    function Memory_Models_Game_ClockFactory(App_Common_Abstracts_Model, $interval) {
        /**
         * todo: provide short description of model
         *
         * @class   Memory_Models_Game_Clock
         * @extends     App_Common_Abstracts_Model
         * @param       {Object}     [data]            - data array for setting properties during instantiation
         * @this        Memory_Models_Game_Clock
         * @returns     {function}
         */
        function Memory_Models_Game_Clock(data) {
            ...
            /**
             * @property    Memory_Models_Game_Clock#minutes      - minutes remaining
             * @type        string
             * @public
             **/
            Object.defineProperty(self,'minutes',{get: getMinutes,set: setMinutes});
            /**
             * @property    Memory_Models_Game_Clock#seconds      - seconds remaining
             * @type        string
             * @public
             **/
            Object.defineProperty(self,'seconds',{get: getSeconds,set: setSeconds});
            /**
             * @property    Memory_Models_Game_Clock#now      - number of seconds remaining on the clock
             * @type        int
             * @public
             **/
            Object.defineProperty(self,'now',{get: getNow,set: setNow});
            /**
             * @property    Memory_Models_Game_Clock#duration      - number of seconds to start on clock
             * @type        int
             * @public
             **/
            ...
            /**
             * @property    Memory_Models_Game_Clock#callOnExpire      - callback function to launch when clock expires
             * @type        function
             * @public
             **/
        ...
        Memory_Models_Game_Clock.prototype = Object.create(App_Common_Abstracts_Model.prototype);
        Memory_Models_Game_Clock.prototype.constructor = Memory_Models_Game_Clock;
        ...
        return Memory_Models_Game_Clock;
    }

    Memory_Models_Game_ClockFactory.$inject = ['App_Common_Abstracts_Model','$interval'];

    angular.module('App_Memory').factory('Memory_Models_Game_Clock', Memory_Models_Game_ClockFactory);
})();
